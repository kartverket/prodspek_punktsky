:datasett: Punktsky
:versjon: 1.0.1
:publisert: 2022-03-11
:prodspek-forrige: Produktspesifikasjon_Punktsky_1.0.pdf
:metadata-url: 
:versjon-forrige: Punktsky v1.0 2022-01-01
...
:prodspek-forrige-url: {prodspekbase-url}{datasett}/1.0
