...
:prodspek-forrige: Produktspesifikasjon_Punktsky_1.0.1.pdf
:metadata-url: 
:versjon-forrige: Punktsky v1.0.1 2022-03-11
...
:title-page-background-image: image:C:/00Bitbucket/dokumentasjon_fkb/felles/figurer/forsidebilde_kartverketstandarder.jpg[]
...
:prodspek-forrige-url: {prodspekbase-url}{datasett}
...
==== Endringer siden Punktsky 1.0.1 - 2022-03-11:
* Rettet feil i klassekode for vannflate

==== Endringer siden Punktsky 1.0 - 2022-01-01:
* Presisering fotavtrykk for Luftbåren Topografisk LiDAR
* Rettet feil krav til grunnrissnøyaktighet i bildematching for kategori Psky_1_DIM_C. 
...
[discrete]
== Lisensvilkår
include::C:/00Bitbucket/dokumentasjon_fkb/felles/lisensvilkaar.adoc[]
