...
MBES: 
Justering skrankeverdier MBES nøyakgithet: 
Justering krav til vertikal nøyaktighet: 
Absolutt    0.12m + 0.002*dybde
Presisjon   0.08m + 0.002*dybde

ALB
Tetthet: Vurdere å flytte fra Psky_1_ALB_B til Psky_1_ALB_C for å bedre gjengi tetthetsforventning
Krav til tetthet omskrives fra: 
